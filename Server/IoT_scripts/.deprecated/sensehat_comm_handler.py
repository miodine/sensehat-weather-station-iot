...
class SHCH:
	...
	def dump_temperature_from_pressure_json(self, unit: str) -> str:
		fname = "temperature_from_pressure"
		self.json_placeholder['name'] = fname
		fname = "advanced/"+fname
		
		
		value = self._sense.get_temperature_from_pressure()
	...
	def dump_temperature_from_humidity_json(self, unit: str) -> str:
		fname = "temperature_from_humidity"
		self.json_placeholder['name'] = fname
		fname = "advanced/"+fname
		
		value = self._sense.get_temperature_from_humidity()
	...
	# Dumps the direction of North from the magnetometer in degrees
	def dump_compass_json(self) -> str:
		unit = "deg"
		...
		fname = "advanced/"+fname
		value = self._sense.get_compass_raw()
		self.json_placeholder['unit'] = unit
		self.json_placeholder['value'] = value
	...
	def dump_roll_from_accelerometer_json(self, unit: str) -> str:
		fname = "roll"
		self.json_placeholder['name'] = fname
		fname = "advanced/"+fname
		value = self._sense.get_accelerometer()['roll']
		self.json_placeholder['unit'] = "deg"
		self.json_placeholder['value'] = value
	...
	def dump_pitch_from_accelerometer_json(self, unit: str) -> str:
		fname = "pitch"
		self.json_placeholder['name'] = fname
	...
	def dump_yaw_from_accelerometer_json(self, unit: str) -> str:
		fname = "yaw"
		self.json_placeholder['name'] = fname
	...
	def dump_all_to_server(self, advanced = False):
